 ...
 *
 */
class Example2: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMExample2Signal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMExample2Signal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class Example2::CEDROOMMemory
	...
	//! Constructor
	Example2(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
