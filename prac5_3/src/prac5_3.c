...
/*
 * Parte 5_3
 * Declaración de un semaforo mutex
 */
rtems_id MutexId;
...
rtems_task Init(rtems_task_argument argument) {
////parte 5_3
	//creación de semaforo dentro de la funcion  init
	rtems_attribute mutex_attribute = RTEMS_PRIORITY | RTEMS_BINARY_SEMAPHORE
			| RTEMS_INHERIT_PRIORITY;
	rtems_semaphore_create(MutexName, 1, mutex_attribute, RTEMS_NO_PRIORITY,
			&MutexId);
////
